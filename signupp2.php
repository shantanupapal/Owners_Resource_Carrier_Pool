...
if($count==0){
  ...
  $endtime = $_POST["endtime"];
   ...
   $insert = array(firstname=> $firstname, lastname=> $lastname, username=>$username,
   password=>$password, email=>$email, phoneno=>$phoneno, haddress=>$haddress ,
   hcity=>$hcity, hpincode=>$hpincode, hstate=>$hstate, waddress=>$waddress,
   wcity=>$wcity, wpincode=>$wpincode, wstate=>$wstate, starttime=>$starttime,
   endtime=>$endtime);
